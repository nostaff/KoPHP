 ...
 * @package    Security
 * @author     Ko Team, Eric
 * @version    $Id: security.php 109 2011-06-05 07:00:30Z eric $
...
class Security
{
    ...
    public static function xss_clean($str)
    {
        ...
        $str = html_entity_decode($str, ENT_COMPAT, Ko::$charset);
    ...
    /**
     * Encodes HTML tags in a string.
     *
     *     $str = Security::encode_html_tags($str);
     *
     * @param   string  string to sanitize
     * @return  string
     */    
    public static function encode_html_tags($str)
    {
        //$str = str_replace('\0' ,' ', $str);
    	$str =htmlspecialchars(stripslashes($str), ENT_QUOTES, Ko::$charset);
