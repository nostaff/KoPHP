 ...
 * @package    Image
 * @author     Ko Team, Eric 
 * @version    $Id: image.php 78 2009-10-09 04:01:57Z eric $
...
abstract class Image
{
    ...
    public function __construct ($file)
    {
        ...
        } catch (Exception $e) {    // Ignore all errors while reading the image
        }
        if (empty($file) or empty($info)) {
            throw new KoException('Not an image or invalid image: :file', array(':file' => Ko::debug_path($file)));
        }
