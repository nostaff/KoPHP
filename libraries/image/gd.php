 ...
 * @package    Image
 * @author     Ko Team, Eric 
 * @version    $Id: gd.php 109 2011-06-05 07:00:30Z eric $
...
class Image_GD extends Image
{
    ...
    public function __construct ($file)
    {
        ...
        if (! isset($create) or ! function_exists($create)) {
            throw new KoException('Installed GD does not support :type images', array(':type' => image_type_to_extension($this->type, FALSE)));
        }
    ...
    /**
     * Make image background with the given color value and opacity.
     *
     * @param int $r
     * @param int $g
     * @param int $b
    ...
    /**
     * Save image with the given filename and quality.
     *
     * @param string $file
     * @param int $quality
     * @return resource
    ...
    protected function _save_function ($extension, & $quality)
    {
        switch ($extension) {
            ...
            case 'png':
                ...
                break;
            default:
                throw new KoException('Installed GD does not support :type images', array(':type' => $type));
                break;
        }
